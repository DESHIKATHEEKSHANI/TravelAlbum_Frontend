...
const Home = () => {
  ...
  const handleAuthSuccess = () => {
    // Close auth modal
    setAuthMode(null);
    // Navigate to the dashboard is now handled by useEffect when user state changes
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-800 via-blue-600 to-cyan-400 text-white overflow-hidden relative">
      ...
      <Navbar onSignInClick={handleSignInClick} user={user} logout={logout} />
            ...
            {authMode === "login" ? (
              ...
              <>
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
                  ...
                  <button className="border border-amber-200/30 bg-amber-50/10 px-8 py-4 rounded-full font-medium hover:bg-amber-50/20 transition-all flex items-center justify-center space-x-3">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      height="20"
...
// Updated Navbar Component to handle user state
const Navbar = ({ onSignInClick, user, logout }) => {
  return (
